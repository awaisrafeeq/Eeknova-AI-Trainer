kro# feedback_processor.py - Video Processing with Feedback
...
class GuidedZumbaAnalyzer:
    ...
    def __init__(
        ...
        reference_file: str = r"D:\My_AI_Projects\test_projects\poseEstimationModule\feedback_generation_real_time\improved_automatic_references.json",
    ...
    def guide_live(self, target_move, cam_id=0):
        ...
        while True:
            ...
            if res and res[0].keypoints is not None:
                ...
                # Check if at least one shoulder (5 or 6) and one foot (15 or 16) are detected
                if (kps[5][2] > 0.5 or kps[6][2] > 0.5) and (kps[15][2] > 0.5 or kps[16][2] > 0.5):
